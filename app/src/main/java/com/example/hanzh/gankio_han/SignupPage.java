...
import com.example.hanzh.gankio_han.view.PicViewer;
...
//					Toast.makeText(activity, "注册成功", Toast.LENGTH_SHORT).show();
					SPUtils.put(this.activity, "usericon", userInfo.getUserIcon());
					SPUtils.put(this.activity, "username", userInfo.getUserName());
//					SPUtils.put(this.activity,"usergender",userInfo.getUserGender());
//					SPUtils.put(this.activity,"usernote",userInfo.getUserNote());
					successInterface.isRegisterSuccess(true);
					finish();
				} else {
	...
	public void setSignListener(SuccessInterface successInterface) {
